 ...
 */
public class CqlConcurrentBulkRecordWriter extends AbstractBulkRecordWriter<Object, List<ByteBuffer>>
{
    ...
    CqlConcurrentBulkRecordWriter(TaskAttemptContext context) throws IOException
    {
        super(context);
        setConfigs();
    }

    CqlConcurrentBulkRecordWriter(Configuration conf, Progressable progress) throws IOException
    {
        super(conf, progress);
        setConfigs();
    }

    CqlConcurrentBulkRecordWriter(Configuration conf) throws IOException
    {
        super(conf);
        setConfigs();
    }
