 ...
 * </p>
 */
public class CqlConcurrentBulkOutputFormat extends AbstractBulkOutputFormat<Object, List<ByteBuffer>>
{   
  ...
  @Deprecated
  public CqlConcurrentBulkRecordWriter getRecordWriter(FileSystem filesystem, JobConf job, String name, Progressable progress) throws IOException
  {
      return new CqlConcurrentBulkRecordWriter(job, progress);
  }
   ...
   * @throws IOException
   */
  public CqlConcurrentBulkRecordWriter getRecordWriter(final TaskAttemptContext context) throws IOException, InterruptedException
  {
      return new CqlConcurrentBulkRecordWriter(context);
  }
